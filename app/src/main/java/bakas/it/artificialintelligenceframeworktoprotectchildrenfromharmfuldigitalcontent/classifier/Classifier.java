package bakas.it.artificialintelligenceframeworktoprotectchildrenfromharmfuldigitalcontent.classifier;
/**
    ...
    private TensorImage loadImage(Bitmap bitmap) {
        ...
        ImageProcessor imageProcessor =
                new ImageProcessor.Builder() // Initializing an Image Process pipeline
                        ...
                        .add(new ResizeOp(224, 224, ResizeOp.ResizeMethod.NEAREST_NEIGHBOR)) // Resize picture
